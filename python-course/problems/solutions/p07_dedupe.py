"""
Reference solution for problems/p07_dedupe.py  —  Duplicates & dedupe                     [Easy-Medium · sets]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p07_dedupe.py
...
problem = load_problem('problems/p07_dedupe.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p07_dedupe' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
