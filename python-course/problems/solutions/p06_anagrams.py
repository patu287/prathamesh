"""
Reference solution for problems/p06_anagrams.py  —  Anagrams & character counts               [Easy-Medium · hashing]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p06_anagrams.py
...
problem = load_problem('problems/p06_anagrams.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p06_anagrams' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
