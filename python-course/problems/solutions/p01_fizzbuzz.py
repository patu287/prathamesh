"""
Reference solution for problems/p01_fizzbuzz.py  —  FizzBuzz                                  [Easy · loops, conditions]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p01_fizzbuzz.py
...
problem = load_problem('problems/p01_fizzbuzz.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p01_fizzbuzz' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
