"""
Reference solution for problems/p19_linked_list.py  —  Linked lists                              [Hard · pointers]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p19_linked_list.py
...
problem = load_problem('problems/p19_linked_list.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p19_linked_list' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
