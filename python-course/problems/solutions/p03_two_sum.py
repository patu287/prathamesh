"""
Reference solution for problems/p03_two_sum.py  —  Two Sum                               [Easy · hash map, arrays]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p03_two_sum.py
...
problem = load_problem('problems/p03_two_sum.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p03_two_sum' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
