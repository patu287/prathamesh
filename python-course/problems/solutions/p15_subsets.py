"""
Reference solution for problems/p15_subsets.py  —  Subsets (the power set)                [Medium-Hard · backtracking]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p15_subsets.py
...
problem = load_problem('problems/p15_subsets.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p15_subsets' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
