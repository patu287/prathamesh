"""
Reference solution for problems/p04_array_basics.py  —  Array basics: min, max, second largest     [Easy · arrays, one pass]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p04_array_basics.py
...
problem = load_problem('problems/p04_array_basics.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p04_array_basics' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
