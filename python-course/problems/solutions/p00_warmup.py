"""
Reference solution for problems/p00_warmup.py  —  Warm-up                       [Trivial]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p00_warmup.py
...
problem = load_problem('problems/p00_warmup.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p00_warmup' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
