"""
Reference solution for problems/p02_strings_basics.py  —  Strings: reverse, palindrome, words     [Easy · strings, two pointers]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p02_strings_basics.py
...
problem = load_problem('problems/p02_strings_basics.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p02_strings_basics' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
