"""
Reference solution for problems/p12_stacks.py  —  Stacks: brackets & path cleaning          [Medium · stacks]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p12_stacks.py
...
problem = load_problem('problems/p12_stacks.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p12_stacks' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
