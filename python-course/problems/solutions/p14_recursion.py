"""
Reference solution for problems/p14_recursion.py  —  Recursion fundamentals                   [Medium · recursion]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p14_recursion.py
...
problem = load_problem('problems/p14_recursion.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p14_recursion' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
