"""
Reference solution for problems/p13_fibonacci.py  —  Fibonacci & stairs                       [Medium · DP, recursion]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p13_fibonacci.py
...
problem = load_problem('problems/p13_fibonacci.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p13_fibonacci' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
