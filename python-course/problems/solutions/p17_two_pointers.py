"""
Reference solution for problems/p17_two_pointers.py  —  Two pointers on sorted data            [Medium · two pointers]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p17_two_pointers.py
...
problem = load_problem('problems/p17_two_pointers.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p17_two_pointers' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
