"""
Reference solution for problems/p05_frequency.py  —  Frequency counting                     [Easy · dict / Counter]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p05_frequency.py
...
problem = load_problem('problems/p05_frequency.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p05_frequency' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
