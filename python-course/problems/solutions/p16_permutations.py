"""
Reference solution for problems/p16_permutations.py  —  Permutations                          [Medium-Hard · backtracking]

    ▶ run all   : python3 tools/grade.py --solutions problems
    ▶ run this  : python3 problems/solutions/p16_permutations.py
...
problem = load_problem('problems/p16_permutations.py')
exec(problem.SOLUTION, problem.__dict__)     # replace the stubs with the solution

if __name__ == "__main__":
    run_expressions('p16_permutations' + " (reference solution)", problem.CASES, problem.__dict__)
    summary()
